...
const PRODUCT_ID = "62a1985493de826dc8904342";
var DEVICE_ID = "";
var DATA = {};
...
chrome.runtime.onInstalled.addListener(async () => {
  ...
  //Testing
  //chrome.storage.local.set({ license_key: "0INL-qpKb-Z8Vz-ZvFE" });
  //DEVICE_ID = "123abc";
...
chrome.runtime.onMessage.addListener((message, sender, sendResponse) => {
  ...
  if (message.type === "get_phone_from_address") {
    ...
    let inputSocial = message.network;
    let inputCountry = message.country;


    let keywordId = inputKeyword.replace(/ /g, "_").toLowerCase()+"_"+inputLocation.replace(/ /g, "_").toLowerCase();;
    ...
    chrome.storage.local.get("scrap", function (cfg) {
      if (cfg.scrap) {
        if (cfg.scrap.hasOwnProperty(keywordId)) {
          ...
          cfg.scrap[keywordId] = {
            name: inputKeyword + " - " + inputLocation,
      ...
      //https://www.google.com/search?q=%22%2B91%22%20doctor%20AND%20ahmedabad%20site:facebook.com
      //"+91" doctor AND ahmedabad site:facebook.com

      //https://www.google.com/search?q=%22email%22%20doctor%20AND%20ahmedabad%20site:facebook.com
      //"email" doctor AND ahmedabad site:facebook.com

  // const url =
  //  "https://www.google.com/search?q=" + "phone" == r
  //     ? (r = '"'+countryCode+'" ')
  //     : "email" == r && (r = '"email" '),
  //   a + r + encodeURI(e + " AND " + t + " site:" + o + ".com")
  // );

  const url = "https://www.google.com/search?q=" + encodeURI('"'+inputCountry+'" "email" '+ inputKeyword + " AND " + inputLocation + " site:" + inputSocial + ".com&num=10&start=0") + "&keyword=" +keywordId
...
(async () => {
  ...
  // console.log("libphonenumber:", libPhoneNumber.AsYouType('US').input('213-373-4253'));
  // const phones =  libPhoneNumber.findPhoneNumbersInText("Book your checkup now, Call +91 99881 14433 / +91 96620 02255 ... Many treatment options are available for people with infertility. . . Consult our expert doctor",'US');
